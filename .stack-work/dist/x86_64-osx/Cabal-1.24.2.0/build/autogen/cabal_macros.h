...
/* package happy-site-0.1.0.0 */
#define VERSION_happy_site "0.1.0.0"
#define MIN_VERSION_happy_site(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package lucid-2.9.8.1 */
#define VERSION_lucid "2.9.8.1"
#define MIN_VERSION_lucid(major1,major2,minor) (\
  (major1) <  2 || \
  (major1) == 2 && (major2) <  9 || \
  (major1) == 2 && (major2) == 9 && (minor) <= 8)
...
#define CURRENT_COMPONENT_ID "happy-site-0.1.0.0"

#define CURRENT_PACKAGE_KEY "happy-site-0.1.0.0"
